...
function wdGetViewport(xmin::Ptr{Cint}, xmax::Ptr{Cint}, ymin::Ptr{Cint}, ymax::Ptr{Cint})
  ccall( (:wdGetViewport, libwd_), None, (Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), xmin, xmax, ymin, ymax)
end
function wdWorld2Canvas(xw::Cdouble, yw::Cdouble, xv::Ptr{Cint}, yv::Ptr{Cint})
  ccall( (:wdWorld2Canvas, libwd_), None, (Cdouble, Cdouble, Ptr{Cint}, Ptr{Cint}), xw, yw, xv, yv)
end
...
function wdClipArea(xmin::Cdouble, xmax::Cdouble, ymin::Cdouble, ymax::Cdouble)
  ccall( (:wdClipArea, libwd_), None, (Cdouble, Cdouble, Cdouble, Cdouble), xmin, xmax, ymin, ymax)
end
...
function wdOffsetRegion(x::Cdouble, y::Cdouble)
  ccall( (:wdOffsetRegion, libwd_), None, (Cdouble, Cdouble), x, y)
end
function wdRegionBox(xmin::Ptr{Cdouble}, xmax::Ptr{Cdouble}, ymin::Ptr{Cdouble}, ymax::Ptr{Cdouble})
  ccall( (:wdRegionBox, libwd_), None, (Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), xmin, xmax, ymin, ymax)
end
function wdHardcopy(ctx::Ptr{Cint}, data::Ptr{None}, cnv::Ptr{Cint}, draw_func::Ptr{Void})
  ccall( (:wdHardcopy, libwd_), None, (Ptr{Cint}, Ptr{None}, Ptr{Cint}, Ptr{Void}), ctx, data, cnv, draw_func)
end
function wdPixel(x::Cdouble, y::Cdouble, color::Clong)
  ccall( (:wdPixel, libwd_), None, (Cdouble, Cdouble, Clong), x, y, color)
end
function wdMark(x::Cdouble, y::Cdouble)
  ccall( (:wdMark, libwd_), None, (Cdouble, Cdouble), x, y)
end
function wdLine(x1::Cdouble, y1::Cdouble, x2::Cdouble, y2::Cdouble)
  ccall( (:wdLine, libwd_), None, (Cdouble, Cdouble, Cdouble, Cdouble), x1, y1, x2, y2)
end
function wdVertex(x::Cdouble, y::Cdouble)
  ccall( (:wdVertex, libwd_), None, (Cdouble, Cdouble), x, y)
end
function wdRect(xmin::Cdouble, xmax::Cdouble, ymin::Cdouble, ymax::Cdouble)
  ccall( (:wdRect, libwd_), None, (Cdouble, Cdouble, Cdouble, Cdouble), xmin, xmax, ymin, ymax)
end
function wdBox(xmin::Cdouble, xmax::Cdouble, ymin::Cdouble, ymax::Cdouble)
  ccall( (:wdBox, libwd_), None, (Cdouble, Cdouble, Cdouble, Cdouble), xmin, xmax, ymin, ymax)
end
function wdArc(xc::Cdouble, yc::Cdouble, w::Cdouble, h::Cdouble, angle1::Cdouble, angle2::Cdouble)
  ccall( (:wdArc, libwd_), None, (Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble), xc, yc, w, h, angle1, angle2)
end
function wdSector(xc::Cdouble, yc::Cdouble, w::Cdouble, h::Cdouble, angle1::Cdouble, angle2::Cdouble)
  ccall( (:wdSector, libwd_), None, (Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble), xc, yc, w, h, angle1, angle2)
end
function wdChord(xc::Cdouble, yc::Cdouble, w::Cdouble, h::Cdouble, angle1::Cdouble, angle2::Cdouble)
  ccall( (:wdChord, libwd_), None, (Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble), xc, yc, w, h, angle1, angle2)
end
...
function wdPutBitmap(bitmap::Ptr{Cint}, x::Cdouble, y::Cdouble, w::Cdouble, h::Cdouble)
  ccall( (:wdPutBitmap, libwd_), None, (Ptr{Cint}, Cdouble, Cdouble, Cdouble, Cdouble), bitmap, x, y, w, h)
end
...
function wdGetFont(type_face::Ptr{Cint}, style::Ptr{Cint}, size::Ptr{Cdouble})
  ccall( (:wdGetFont, libwd_), None, (Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}), type_face, style, size)
end
...
function wdFontDim(max_width::Ptr{Cdouble}, height::Ptr{Cdouble}, ascent::Ptr{Cdouble}, descent::Ptr{Cdouble})
  ccall( (:wdFontDim, libwd_), None, (Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), max_width, height, ascent, descent)
end
function wdTextSize(s::String, width::Ptr{Cdouble}, height::Ptr{Cdouble})
  ccall( (:wdTextSize, libwd_), None, (Ptr{Uint8}, Ptr{Cdouble}, Ptr{Cdouble}), s, width, height)
end
function wdTextBox(x::Cdouble, y::Cdouble, s::String, xmin::Ptr{Cdouble}, xmax::Ptr{Cdouble}, ymin::Ptr{Cdouble}, ymax::Ptr{Cdouble})
  ccall( (:wdTextBox, libwd_), None, (Cdouble, Cdouble, Ptr{Uint8}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), x, y, s, xmin, xmax, ymin, ymax)
end
...
function wdVectorTextDirection(x1::Cdouble, y1::Cdouble, x2::Cdouble, y2::Cdouble)
  ccall( (:wdVectorTextDirection, libwd_), None, (Cdouble, Cdouble, Cdouble, Cdouble), x1, y1, x2, y2)
end
function wdVectorTextSize(size_x::Cdouble, size_y::Cdouble, s::String)
  ccall( (:wdVectorTextSize, libwd_), None, (Cdouble, Cdouble, Ptr{Uint8}), size_x, size_y, s)
end
function wdGetVectorTextSize(s::String, x::Ptr{Cdouble}, y::Ptr{Cdouble})
  ccall( (:wdGetVectorTextSize, libwd_), None, (Ptr{Uint8}, Ptr{Cdouble}, Ptr{Cdouble}), s, x, y)
end
...
function wdVectorText(x::Cdouble, y::Cdouble, s::String)
  ccall( (:wdVectorText, libwd_), None, (Cdouble, Cdouble, Ptr{Uint8}), x, y, s)
end
function wdMultiLineVectorText(x::Cdouble, y::Cdouble, s::String)
  ccall( (:wdMultiLineVectorText, libwd_), None, (Cdouble, Cdouble, Ptr{Uint8}), x, y, s)
end
function wdGetVectorTextBounds(s::String, x::Cdouble, y::Cdouble, rect::Ptr{Cdouble})
  ccall( (:wdGetVectorTextBounds, libwd_), None, (Ptr{Uint8}, Cdouble, Cdouble, Ptr{Cdouble}), s, x, y, rect)
end
