...
function imFileSetAttribute(ifile::Ptr{imFile}, attrib::String, data_type::Integer, count::Integer, data::Ptr{None})
...
function imFileReadImageData(ifile::Ptr{imFile}, data::Ptr{None}, convert2bitmap::Integer, color_mode_flags::Integer)
